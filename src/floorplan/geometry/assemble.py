...
FACTORS_PATH = os.path.join(os.path.dirname(__file__), "..", "calibration", "factors.json")
...
def build_plan(rooms: list[RoomOut], edges_adj: list[dict], tier: str, capture: dict, timing: dict,
    ...
    plan = {
        ...
        "calibration": {"nominal_coverage": 0.9,
                        ...
                        "calibration_set_id": "analysis/bench/latest", "tier_floor_fraction": fl, "factors": factors},
        "timing": timing,
        "render": render,
