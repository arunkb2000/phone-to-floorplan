...
`before` = tag `fixloop-before` (9dca162d6), `after` = tag `fixloop-after` (a86e1b3af). Both runs regenerate with `make before` and `make after`.
...
```
floorplan/__init__.py               |   3 -
 floorplan/calib/__init__.py         |   0
 floorplan/calib/factors.json        |   1 -
 floorplan/calib/fit.py              |  61 ---
 floorplan/cli/__init__.py           |   0
 floorplan/cli/bench.py              | 303 -------------
 floorplan/cli/main.py               | 141 ------
 floorplan/core/__init__.py          |   0
 floorplan/core/room.py              |  40 --
 floorplan/core/types.py             | 106 -----
 floorplan/damage/__init__.py        |   0
 floorplan/damage/detect.py          | 247 ----------
 floorplan/damage/pipeline.py        |  99 ----
 floorplan/damage/project.py         | 167 -------
 floorplan/geometry/__init__.py      |   0
 floorplan/geometry/assemble.py      | 118 -----
 floorplan/geometry/cloud.py         | 392 ----------------
 floorplan/geometry/depth.py         |  76 ----
 floorplan/geometry/drift.py         | 127 ------
 floorplan/geometry/frame.py         | 454 -------------------
 floorplan/geometry/layout.py        | 298 ------------
 floorplan/geometry/lidar.py         | 346 --------------
 floorplan/geometry/room.py          | 350 --------------
 floorplan/geometry/stitch.py        |  68 ---
 floorplan/io/__init__.py            |   0
 floorplan/io/photos.py              |  94 ----
 floorplan/io/stray.py               | 167 -------
 floorplan/io/synthetic.py           | 743 ------------------------------
 floorplan/io/synthetic_rgb.py       | 877 ------------------------------------
 floorplan/io/video.py               | 125 -----
 floorplan/render/__init__.py        |   4 -
 floorplan/render/plan.py            | 457 -------------------
 floorplan/schema/output.schema.json | 195 --------
 floorplan/scope/__init__.py         |   0
 floorplan/scope/catalogue.yaml      |  61 ---
 floorplan/scope/engine.py           | 317 -------------
 floorplan/scope/rules.yaml          |  75 ---
 floorplan/tiers/__init__.py         |   0
 floorplan/tiers/common.py           |  44 --
 floorplan/tiers/lidar.py            | 124 -----
 floorplan/tiers/mono.py             | 189 --------
 floorplan/tiers/photo.py            |  15 -
 floorplan/tiers/video.py            |  74 ---
 43 files changed, 6958 deletions(-)
```
