...
from floorplan.geometry.layout import (close_polygon, orient_edges, rectilinear, refine_edges,
                                       room_ceiling, room_contour, trim_edges, wall_openings)
...
def run_lidar(capture_dir: str, *, drift_correction: bool, log: dict, target_fps: float = 4.0,
    ...
    for r in range(1, int(lab.max()) + 1):
        ...
        for k, e in enumerate(edges):
            ...
            sig = e.sigma if e.refined else max(0.06, 0.02 * e.length)
